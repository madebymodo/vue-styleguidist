...
exports.extractConfig = extractConfig_1.default;
var getSources_1 = __importDefault(require("./getSources"));
function hasComponents(config) {
    return !!config.components;
}
exports.default = (function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, watcher, componentFiles, docMap;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, getSources_1.default(config.components, config.componentsRoot, config.getDocFileName, config.apiOptions)];
            case 1:
                _a = _b.sent(), watcher = _a.watcher, componentFiles = _a.componentFiles, docMap = _a.docMap;
                if (!config.outFile) return [3 /*break*/, 3];
                // create one combined documentation file
                return [4 /*yield*/, singleMd_1.default(componentFiles, watcher, config, docMap)];
            case 2:
                // create one combined documentation file
                _b.sent();
                return [3 /*break*/, 5];
            ...
            return [4 /*yield*/, multiMd_1.default(componentFiles, watcher, config, docMap)];
            case 4:
                // create one documentation file per component
                _b.sent();
                _b.label = 5;
