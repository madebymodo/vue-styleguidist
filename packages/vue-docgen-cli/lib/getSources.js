 ...
 */
function getSources(components, cwd, getDocFileName, optionsApi) {
    if (optionsApi === void 0) { optionsApi = {}; }
    return __awaiter(this, void 0, void 0, function () {
        var watcher, allComponentFiles, requiredComponents, componentFiles, docMap;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    watcher = chokidar_1.default.watch(components, { cwd: cwd });
                    return [4 /*yield*/, globby_1.default(components, { cwd: cwd })
                ...
                case 2:
                    ...
                    componentFiles, getDocFileName, cwd);
                    watcher.add(Object.keys(docMap));
                    return [2 /*return*/, { watcher: watcher, docMap: docMap, componentFiles: componentFiles }];
            }
        });
    });
}
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, vue_docgen_api_1.parse(absoluteComponentPath, __assign(__assign({ 
                            ...
                            jsx: false }, optionsApi), { scriptHandlers: [vue_docgen_api_1.ScriptHandlers.componentHandler] }))];
                case 2:
                    tags = (_b.sent()).tags;
